...
class InstagramcomSpider(scrapy.Spider):
    ...
    insta_login = 'Enter you instagram login'
    insta_pwd = 'Copy your PWD from browser'
    inst_login_link = 'https://www.instagram.com/accounts/login/ajax/'

    graphql_url = 'https://www.instagram.com/graphql/query/?'

    subscribers_hash = '8c2a529969ee658a5063f2fc8602a0fd'
    subscriptions_hash = 'd04b0a864b4b9954c0d870b0e77e076'
